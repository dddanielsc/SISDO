        ...
        <div class="col-xs-12 col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class = "form-horizontal" role = "form" action ="usuarioPOST.php?id=&acao=inserir" method = "POST" id="post">
                        <div class = "form-group">
                            <label for = "inputUsuario" class = "col-sm-2 control-label">Usuário</label>
                            <div class = "col-sm-6">
                                <input type = "text" class = "form-control" id = "input_nome_usuario" name = "usuario" placeholder = "user" value = "teste">
                            </div>
                        </div>
                        <div class = "form-group">
                            <label for = "inputUsuario" class = "col-sm-2 control-label">E-mail</label>
                            <div class = "col-sm-3">
                                <input type = "email" class = "form-control" id = "input_email" name = "email" placeholder = "@mail.com" value = "teste@tetse.com">
                            </div>
                        </div>
                        <div class = "form-group">
                            <label for = "inputUsuario" class = "col-sm-2 control-label">Senha</label>
                            <div class = "col-sm-3">
                                <input type = "password" class = "form-control" id = "input_senha" name = "senha" placeholder = "Mín. 6 dígitos" >
                            </div>
                        </div>
                        <div class = "form-group">
                            ...
                            <div class = "col-sm-3">
                                ...
                                <select id = "basic2" name="basic2" class = "show-tick form-control" multiple>
                                    ...
                                    while ($i < $laco) {
                                        ...
                                        echo '<option value="'.$p->getCod_pessoa().'">' . $p->getNome_pessoa() . '</option>';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select id="basic4" name="basic4" class="show-tick form-control" multiple>
                                    ...
                                    while ($i < $laco) {
                                        ...
                                        echo '<option value="'.$tipo_usuario->getCod_TipoUsuario().'">' . $tipo_usuario->getTipoUsuario() . '</option>';
                        ...
                        <button type="submit" class="btn btn-primary" id="btnCadastra">Cadastrar</button>
                    </form> 
                    <!--                                    FORMULÁRIO DE CADASTRO-->
